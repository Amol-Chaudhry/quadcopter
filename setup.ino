...
void loop(){
  ...
  if(error == 0){  
    Serial.println(F("Move throttle to full throttle and back to center"));
    ...
    Serial.println(F(""));
    Serial.println(F(""));
    Serial.println(F("Move roll to simulate left wing up & back to center"));
  ...
  if(error == 0){
    Serial.println(F(""));
    Serial.println(F(""));
    Serial.println(F("Move pitch to simulate nose up & back to center"));
  ...
  if(error == 0){
    Serial.println(F(""));
    Serial.println(F(""));
    Serial.println(F("Move yaw  simulate nose right & back to center"));
  ...
  if(error == 0){
    Serial.println(F(""));
    Serial.println(F(""));
    Serial.println(F("move all the sticks simultaneously to their extends"));
    Serial.println(F("If ready put the sticks back in their center positions"));
  ...
  if(error == 0){
    ...
    Serial.println(F("Lift the left of the quadcopter to a 45 degree angle within 10 seconds"));
    ...
    if(error == 0){
      ...
      Serial.println(F("Put the quadrotor back in its original position"));
      Serial.println(F("Move 'nose up' and back to center to continue"));
      check_to_continue();
    ...
    if(error == 0){
      ...
      Serial.println(F(""));
      Serial.println(F(""));
      Serial.println(F("Rotate nose of copter 45 degree to the right within 10 seconds"));
  ...
  if(error == 0){
    ...
    Serial.println(F("Move 'nose up' & back to center to continue"));
    check_to_continue();
    digitalWrite(12, LOW);
  }
